...
{
    public class HzyAdminSpaCodeGenerationController : FrameworkBaseController
    {
        private readonly string _webRootPath;
        private readonly HzyAdminSpaCodeGenerationService _defaultService;

        public HzyAdminSpaCodeGenerationController(HzyAdminSpaCodeGenerationService defaultService, IWebHostEnvironment webHostEnvironment)
        {
